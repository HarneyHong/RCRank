...
class GateComDiffPretrainModel(nn.Module):
    def __init__(self, t_input_dim, l_input_dim, l_hidden_dim, t_hidden_him, emb_dim, sql_model=None, device=None,
                  plan_args=None, cross_model=None, time_model=None, cross_mean=True, cross_model_real=None, cross_model_CrossSQLPlan=None, rootcause_cross_model=None, weight=0.5) -> None:
        super().__init__()
